...
def transforming(cliente, data, start_date, end_date):
    ...
    one_year_ago = datetime.datetime.now() - pd.DateOffset(months=6)  
    ...
    fig4.update_layout(title="Consumo total del último semestre", yaxis_title="Consumo (kWh)",  
